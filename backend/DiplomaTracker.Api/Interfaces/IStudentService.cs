...
public interface IStudentService
{
    ...
    Task<(StudentResponse? student, string? error)> CreateStudentAsync(CreateStudentRequest request, Guid administratorId);
    Task<(StudentResponse? student, string? error)> UpdateStudentAsync(Guid id, UpdateStudentRequest request, Guid administratorId);
